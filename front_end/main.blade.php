...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Welcome</b></a>
        ...
        <div >
                    ...
                    {{-- <form > --}}
                        <div >
                          {{-- <button style="margin-top: -100px;margin-left: 50px;" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select College</button> --}}
