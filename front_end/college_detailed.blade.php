...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div>
        <?
        if($selected_college && $ratio)
        {
            echo "Ratio of". $selected_college. "is" .$ratio;
        }
        ?>
        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="http://www.linkedin.com/rajatdhiman007">Rajat Dhiman</a>, made with love for a better experience
                </p>
            </div>
        </footer>
